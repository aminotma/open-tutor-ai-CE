...
from open_tutorai.routers import response_feedbacks, auths, supports, memories, context_retrieval, adaptive_tutor, chat_capture
...
app.include_router(chat_capture.router, prefix="/api/v1", tags=["chat-capture"])
